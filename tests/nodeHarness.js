"use strict";
var fs = require("fs"), path = require("path"), vm = require("vm"), root = path.resolve(__dirname, ".."), testFile = process.argv[2] || "tests/smokeTests.js";
var elements = {};
function element(id) { return elements[id] || (elements[id] = { id: id, innerHTML: "", textContent: "", className: "", children: [], appendChild: function (child) { this.children.push(child); } }); }
global.window = global; global.addEventListener = function () {};
global.SengokuTestFilter = process.argv[3] ? new RegExp(process.argv[3]) : null;
global.document = { title: "", getElementById: element, createElement: function () { return { className: "", innerHTML: "" }; } };
