...
function element(id) {
  ...
  var item = { id: id, innerHTML: "", textContent: "", className: id === "modalBackdrop" ? "modal-backdrop hidden" : "", children: [], disabled: false, attributes: {}, dataset: {}, focused: false, scrolled: false,
