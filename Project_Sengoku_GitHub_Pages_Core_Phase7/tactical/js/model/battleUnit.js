(function (T) {
  ...
  T.createUnit = function(spec){
    return {
      id:spec.id, officerId:spec.officerId, officerName:spec.officerName, coreOfficerId:spec.coreOfficerId || null, coreUnitId:spec.coreUnitId || null,
      side:spec.side, unitType:spec.unitType, troops:spec.troops, troopsBefore:spec.troops,
      maxTroops:Math.max(spec.troops, Number(spec.maxTroops)||spec.troops), morale:spec.morale === undefined ? 80 : spec.morale, isCommander:!!spec.isCommander,
      ...
      routePoints:[], routeIndex:0, finalFacing:null, plannedOrder:null,
